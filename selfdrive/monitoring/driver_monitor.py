...
class DRIVER_MONITOR_SETTINGS():
  def __init__(self, TICI=TICI, DT_DMON=DT_DMON):
    ...
    self._DISTRACTED_TIME = 15. # active monitoring total timeout
    ...
    self._MAX_TERMINAL_ALERTS = 99  # not allowed to engage after 99 terminal alerts
    self._MAX_TERMINAL_DURATION = int(999 / self._DT_DMON)  # not allowed to engage after 999s of terminal alerts
