...
class StartupAlert(Alert):
  def __init__(self, alert_text_1: str, alert_text_2: str = "Ready to Drive", alert_status=AlertStatus.normal):
    super().__init__(alert_text_1, alert_text_2,
...
EVENTS: Dict[int, Dict[str, Union[Alert, AlertCallbackType]]] = {
  ...
  EventName.startup: {
    ET.PERMANENT: StartupAlert("Ready To Drive")
  },
  ...
  EventName.driverDistracted: {
    ET.WARNING: Alert(
      ...
      "Driver Distracted",
      AlertStatus.critical, AlertSize.full,
      Priority.HIGH, VisualAlert.steerRequired, AudibleAlert.promptDistracted, .1),
  },
